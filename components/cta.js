...
CTA.defaultProps = {
  heading1: 'Ready to cater your event with authentic South Indian cuisine?',
  content1:
    'Fill out the form below to request a catering event from M G Prakash.',
  action1: 'Request Catering Event',
}
